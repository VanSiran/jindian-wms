...
var ListRenderer = BasicRenderer.extend({
    ...
    init: function (parent, state, params) {
        // if (state.model === "wms.kucuncelue"){
        //   _.each(state.data, function(d){
        //     var dd = d.data
        //     if (dd.shangxianbaojing === false) {
        //       dd.shangxian = "未设置"
        //     }
        //     if (dd.xiaxianbaojing === false) {
        //       dd.xiaxian = "未设置"
        //     }
        //     if(dd.shangxianbaojing === false && dd.xiaxianbaojing === false) {
        //       dd.baojingdengji = "未设置"
        //     }
        //   })
        // }
    ...
    _renderBodyCell: function (record, node, colIndex, options) {
        ...
        if (record.model === "wms.kucuncelue") {
          if (name === "shangxian" && record.data["shangxianbaojing"] === false) {
            formattedValue = "未设置"
          }
